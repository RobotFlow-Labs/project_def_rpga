# HACHIMAN — Execution Ledger

Resume rule: Read this file COMPLETELY before writing any code.
This project covers exactly ONE paper: Robust Physical-World Adversarial Camouflage via 3DGS.

## 1. Working Rules
- Work only inside `project_hachiman/`
- This wave has 17 parallel projects, 17 papers, 17 agents
- Prefix every commit with `[HACHIMAN]`
- Stage only `project_hachiman/` files
- VERIFY THE PAPER BEFORE BUILDING ANYTHING

## 2. The Paper
- **Title**: Robust Physical-World Adversarial Camouflage via 3DGS
- **ArXiv**: 2503.16190
- **Link**: https://arxiv.org/abs/2503.16190
